  ...
  registerUser() async {
    setState(() {
      ...
      await _authController.signUpUsers(
        context: context, email: email, fullName: fullName, password: password).whenComplete(() {
          // Xoa cac truong trong mau kiem tra
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        ...
                        Center(child: isLoading ? CircularProgressIndicator(color: Colors.white,) : Text('Sign Up', style: GoogleFonts.getFont(
                          'Lato',
                          color: Colors.white,
                          fontSize: 18,
                          fontWeight: FontWeight.bold
                  ...
                  Row(
                    ...
                    InkWell(
                      ...
                      child: Text(
                        'Sign In', style: GoogleFonts.roboto(
                          color: Color (0xFF2141E5),
                          fontWeight: FontWeight.bold
                        ),
                      ),
